...
class Html
{
    ...
    {
        return self::javascript('/package/jquery/jquery-1.10.1.min.js');
    }

    public static function importBootstrap()
    {
        return self::javascript('/package/bootstrap/js/bootstrap.min.js') . self::css('/package/bootstrap/css/bootstrap.min.css');
    }

    public static function importFontawesome()
    {
        return self::css('/package/font-awesome/css/font-awesome.min.css');
    }
